...
How edgex-foundry-mcp is versioned, built, packaged and published: git tags, GoReleaser binaries and OCI image, the release workflow, and MCP registry metadata.
