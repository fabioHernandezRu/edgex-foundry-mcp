...
The developer experience that keeps the project verifiable: an offline test suite, Makefile targets, the dev EdgeX stack, CI checks, the mcpcall helper client, and the README.
